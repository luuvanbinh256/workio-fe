    ...
    <section className="2xl:max-w-[1600px] xl:max-w-[1350px] max-w-[1170px] relative py-8 px-4 mx-auto">
      <div className="py-8">
        <div className="text-center max-w-[800px] mx-auto mb-16">
          ...
          <h2 className="mt-5 mb-2 text-4xl text-[#f6c93b] font-bold">Unique Features</h2>
        </div>
      </div>
      <div className="grid items-start gap-6 md:grid-cols-2 mb-52">
        <div className="text-white">
          <p className="my-3 text-4xl font-bold text-gradient">AI Assistant</p>
      ...
      <div className="grid items-center gap-6 md:grid-cols-2">
        <div className="">
          <p className="my-3 text-4xl font-bold text-gradient">Go Peer-to-Peer</p>
          <h3 className="max-w-[365px] font-semibold leading-tight text-3xl text-white mb-8">
